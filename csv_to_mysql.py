...
def to_mysql(df_send):
    ...
    for rows in range(df_send.shape[0]):
        ...
        try:
            sql_insert = 'INSERT INTO transaction_flow ({}) VALUES ({});'.format(header_string, insert_string)  # INSERT語法
            #print(sql_insert)
...
if __name__ == '__main__':
    ...
    # 讀取要傳的csv
    df_send = pd.read_csv(r'C:\Users\Big data\Desktop\project\database\Arranged\0607\normal_form_table\transaction_data.csv')
